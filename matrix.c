...
/*   Updated: 2024/01/25 18:40:02 by mbico            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cmatrix_application(t_vars *vars, int i, int j)
{
	...
	vars->links[j][i].x = x * m[0][0] + y * m[0][1]
		+ z * m[0][2] + WIDTH / 2 + vars->viewx;
	vars->links[j][i].y = x * m[1][0] + y * m[1][1]
		+ z * m[1][2] + HEIGHT / 2 + vars->viewy;
}
